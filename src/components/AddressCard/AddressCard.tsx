...
const AddressCard:FC<any> = props => {
    ...
    const addAdressHandler = async () => {
        console.log("fron Address Handler")
		const body = {
			name: addressName,
			phone: phonenumber,
			city_id: cityName,
        ...
        <div className={classes.title}>
            ...
            <div className={classes.layout}>
                <div className={classes.input}>
                    ...
                    <input placeholder='Phone Number' value={phonenumber} onChange={(e:any)=>setPhonenumber(e.target.value) }/>
                </div>
                <div className={classes.input}>
                    <label>City  *</label>
            ...
            <div className={classes.layout}>
                <div className={classes.input}>
                    ...
                    <input placeholder='Street Name' defaultValue={addressName} onChange={(e:any) => setAddressName(e.target.value)}/>
                </div>
                <div className={classes.input}>
            ...
            <div className="">
                        ...
                        <button  className={classes.Edit} onClick={addAdressHandler}>Add another address</button>
										</Map>
									</div>
    </div>
  )
